...
const NavBar = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 bg-[#ecfdf5] transition-shadow duration-300 ${isScrolled ? 'shadow-md' : 'shadow-sm'}`}>
      {/* Small location bar */}
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="px-4 py-3 shadow-inner bg-[#ecfdf5] md:hidden">
